...
class Borrower(BaseModel):
    ...
    customer_number: str = Field(
        ...
        description="Borrower Customer Number"
    )
...
class OpenOffsetSubmission(BaseModel):
    linked_account_number: str = Field(
        ..., min_length=1, max_length=50,
        description="Loan account to link offset to"
    )
    ...
    def validate_consistency(self) -> "OpenOffsetSubmission":
