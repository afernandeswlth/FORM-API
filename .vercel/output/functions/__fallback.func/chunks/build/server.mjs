...
import { p as parseURL, e as encodePath, k as decodePath, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as createHooks, c as createError$1, t as executeAsync, v as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CJi9hH7x.mjs')
  },
  {
    name: "redraw",
    path: "/redraw",
    component: () => import('./redraw-CGfg0Mtz.mjs')
  },
  {
    name: "open-offset",
    path: "/open-offset",
    component: () => import('./open-offset-Djd1Fc0x.mjs')
  },
  {
    name: "direct-debit",
    path: "/direct-debit",
    component: () => import('./direct-debit-BdwZuWHm.mjs')
  },
  {
    name: "linked-account",
    path: "/linked-account",
    meta: __nuxt_page_meta || {},
    component: () => import('./linked-account-Cd65x6Vi.mjs')
  },
  {
    name: "product-switch",
    path: "/product-switch",
    component: () => import('./product-switch-v-SfOQ6B.mjs')
  },
  {
    name: "repayment-change",
    path: "/repayment-change",
    component: () => import('./repayment-change-DvM-Xj_0.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BRZ5AYf6.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D1QUndcl.mjs'));
