...
app = FastAPI(
    title="WLTH Redraw Request API",
    version="1.0.0",
    description=(
        "Digitised submission API for the WLTH Redraw Request Form. "
...
@app.post(
    ...
    summary="Submit a Redraw Request form",
    status_code=201,
)
def submit_form(body: RedrawSubmission):
